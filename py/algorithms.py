...
class RightHandRule(Algorithm):
    ...
    def run(self) -> None:
        ...
        while pos != end:
            ...
            newPos = (pos[0] + RightHandRule.directions[newDir][0], pos[1] + RightHandRule.directions[newDir][1])
            ...
            if self.maze[newPos] == 0:
                ...
                newPos = (pos[0] + RightHandRule.directions[currentDir][0], pos[1] + RightHandRule.directions[currentDir][1])
                if self.maze[newPos] == 0:
                    pos = newPos
                    self.path.add(pos)
                else:
...
l = LoggerGroup(StateLogger(), PathLogger(), StepLogger())
m = MazeState(5, 6, _logger=l)
